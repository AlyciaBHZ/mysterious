...
export const translations: Record<Language, Translations> = {
  ...
  en: {
    ...
    hours: [
      { value: 1, label: '1 (Zi/Rat) 23:00-1:00' },
      { value: 2, label: '2 (Chou/Ox) 1:00-3:00' },
      { value: 3, label: '3 (Yin/Tiger) 3:00-5:00' },
      { value: 4, label: '4 (Mao/Rabbit) 5:00-7:00' },
      { value: 5, label: '5 (Chen/Dragon) 7:00-9:00' },
      { value: 6, label: '6 (Si/Snake) 9:00-11:00' },
      { value: 7, label: '7 (Wu/Horse) 11:00-13:00' },
      { value: 8, label: '8 (Wei/Goat) 13:00-15:00' },
      { value: 9, label: '9 (Shen/Monkey) 15:00-17:00' },
      { value: 10, label: '10 (You/Rooster) 17:00-19:00' },
      { value: 11, label: '11 (Xu/Dog) 19:00-21:00' },
      { value: 12, label: '12 (Hai/Pig) 21:00-23:00' },
    ],
    palaces: {
      大安: 'Da\'an (Great Peace)',
      留连: 'Liulian (Lingering)',
      速喜: 'Suxi (Swift Joy)',
      赤口: 'Chikou (Red Mouth)',
      小吉: 'Xiaoji (Small Luck)',
      空亡: 'Kongwang (Empty Void)',
    },
    elements: {
      木: 'Wood',
      火: 'Fire',
